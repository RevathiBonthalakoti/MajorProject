...
const ShowWeather = (WeatherData) =>{
    ...
    Day5Temperature.innerHTML =  `${WeatherData.forecast.forecastday[6].day.avgtemp_c}`+"&deg;C" ;
    Day5Humidity.innerHTML =  `${WeatherData.forecast.forecastday[6].day.avghumidity}` + "&percnt;";
    Day5Wind.innerHTML =  `${WeatherData.forecast.forecastday[6].day.maxtemp_c}` + "Km/h";
